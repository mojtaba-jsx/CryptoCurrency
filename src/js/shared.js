...
let footerMainColumn2List = document.querySelector('.footer-main__column2-list')

window.addEventListener('load',getCoinInFooter)
function getCoinInFooter (){
  const options = {method: 'GET', headers: {'x-cg-demo-api-key': 'CG-3bjv7fwArQ5Tw29Kii5swyL1'}};
